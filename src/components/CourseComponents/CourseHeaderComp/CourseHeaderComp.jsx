      ...
      <div className={css.innerDiv}>
        <div className={css.leftDiv}>
          <div className={css.url}>
            <span className={css.repo}>Development</span>
            &gt;
            <span className={css.repo}>Web development</span>
            &gt;
            <span className={css.repo}>Angular</span>
          </div>
          ...
          <div className={css.rats}>
            ...
            <div className={css.ratings}>
              <a href={`#`}>({rats} ratings)</a>
            </div>

            <div className={css.enrolled}>{enrolled} students</div>
          </div>
